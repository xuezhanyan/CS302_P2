...
//		 testTrainAi();
	 ...
	 * 1. the basicChooseAction should return 0 when there is no stick 
	 * 2. the basicChooseAction should return 0 when there is negative stick.
	 * 3. the basicChooseAction should return Config.MIN_ACTION If there are 
	 * less than Config.MAX_ACTION sticks remaining.
	 * 4. the basicChooseAction should return number between Config.MIN_ACTION 
	 * and Config.MAX_ACTION when there are more than Config.MAX_ACTION sticks
	 * remaining.
	 * 5. Set seed random object to return fix value. basicChooseAction should 
	 * return the same sequence of random numbers bases on sequences.
	 * 
	 */
	 ...
	 * 1. the aiChooseAction should return 0 when number of stick is 0 or 
	 * actioRanking is null.
	 * 2. the aiChooseAction should return 0 when number of stick is less than
	 * 0.
	 * 3. the aiChooseAction should not return a number which is larger than
	 * Config.MAX_ACTION or smaller than Config.MIN_ACTION.
	 * 4. the aiChooseAction should return Config.MAX_ACTION since the 
	 * possibility of other actions is 0.
	 * 5. Set seed random object to return fix value. aiChooseAction should 
	 * return the same sequence of random numbers bases on sequences.
	 */
	 ...
	 * 1. the initializeActionRanking return when actionRanking is null.
	 * 2. the initializeActionRanking should assign 1 to every element in the 
	 * array no matter what values were stored originally.
	 */
	 ...
	 * 1. The returned String from the actionRankingToString method should match 
	 * expected String
	 * 2. The returned String from the actionRankingToString method should end 
	 ...
	 * 1. Randomly generate an action and assign 2 to be the ranking of this 
	 * action. And then, the updateActionRankingOnLoss method should deduct the 
	 * ranking of this action by 1. The ranking of this action array should be 1 
	 ...
	 * 1. Randomly generate an action and assign 0 to be the ranking of this 
	 * action. And then, the updateActionRankingOnWin method should increase the 
	 * ranking of this action by 1. The ranking of this action array should be 1 
	 * after this method is called.
	 */
	 ...
	 * 1. The number of rows of strategy table should equal to initial sticks.
	 * 2. The number of columns of strategy table should equal the number of 
	 * actions player can choose.
	 * 3. Test whether the element on row 1 column 1 is 1, since all elements 
	 * in the 2-dimensional array should be 1.
	 */
	 ...
	 * 1. The returned String should match the above expected String.
	 */
	 ...
	 * 1. Randomly generate two actions and record the actions in the 
	 * actionHistory, which represent 3 sticks left, 6 sticks left. And then, 
	 * the initial ranking of all action should be 0. After that, 
	...
	/**
	 * This method tests updateStrategyTableOnWin method. 
	 * 1. First, set the ranking of all actions to 2. Randomly generate two 
	 * actions and record the actions in the actionHistory, which represent 3 
	 * sticks left, 6 sticks left. And then, the initial ranking of all action 
	 * should be 0. After that, updateStrategyTableOnLoss should decrement the 
	 * ranking of corresponding action by 1. In this case, the ranking should be 
	 * decreased to 1.
	 */
	 ...
	 * 1.the testPlayAiVsAi method should return 1 or 2 representing computer 1 
	 * or computer 2 win the game 
	 * 2. test whether all values in the history tables are either 0 or between 
	 * Config.MIN_ACTION and Config.MAX_ACTION.
	 * 
	 */
	 ...
	 * 1. Initial sticks should be larger or equal to Config.MIN_STICKS. and 
	 * the trainAi method should return null if initial sticks are smaller than 
	 * Config.MIN_STICKS. 
	 * 2. The number of rows of the strategy table should equal to the initial 
	 * sticks and the number of columns of strategy table should equal to the 
	 * number of actions that player can choose.
	 */
